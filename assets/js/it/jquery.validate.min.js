...
(function(c) {
	...
	c.extend(c.validator, {
		...
		messages : {
			...
			equalTo : "Inserisci lo stesso valore come sopra.",
			accept : "Inserisci un valore con un'estensione valida.",
			maxlength : c.validator.format("Inserisci non più di {0} caratteri."),
			minlength : c.validator.format("Inserisci almeno {0} caratteri."),
			rangelength : c.validator.format("Inserisci un valore compreso tra {0} e {1} caratteri."),
			range : c.validator.format("Inserisci un valore compreso tra {0} e {1}."),
			max : c.validator.format("Inserisci un valore minore o uguale a {0}."),
			min : c.validator.format("Inserisci un valore maggiore o uguale a {0}.")
		},
		...
		prototype : {
			...
			defaultMessage : function(a, b) {
				return this.findDefined(this.customMessage(a.name, b), this.customMetaMessage(a, b), !this.settings.ignoreTitle && a.title || undefined, c.validator.messages[b], "<strong>Attenzione: Nessun messaggio definito per " + a.name + "</strong>")
			},
