...
<table class="table table-bordered table-striped datatable" id="table-2">
	...
	<tbody>
		...
		<tr>
			...
			?>
			<?php echo $property_name.'-'.$property_detail['city'].'-'.$property_detail['provience'];?></td>
        	<td><?php echo get_perticular_field_value('zc_user','user_name'," and user_id='".$property_detail['property_post_by']."'");?></td>
            <td>
