...
<span id="search" style="float:right;">
				<form method="post" action="<?php echo base_url();?>users/user_search">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo $user->email_id?></td>	
                       ...
                       echo '<td>
                            <a href="'.site_url('/users/edit_profile').'/'.$user->user_id.'/" href="javascript:;" class="btn btn-default btn-sm btn-icon btn-xs" title="Click here to edit">
                            ...
                            <a href="'.site_url('/users/statuschange/').'/'.$user->user_id.'/" class="btn btn-info btn-sm btn-icon btn-xs" title="'.$title.'" Onclick="return confirm(\'Are you sure want change status.\')">
                             ...
                             <a href="<?php echo base_url();?>users/delete_user/<?php echo $user->user_id;?>" class="btn-xs btn-red" onclick="return confirm('Are your sure?')">Delete</a>
                           	...
                           	<a href="<?php echo base_url();?>users/view_message/<?php echo $user->user_id;?>" class="btn-xs btn-red" >Message</a> 	
