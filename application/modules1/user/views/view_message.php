		...
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<div id="message_content">
					<ul>
						<li><a href="<?php echo site_url('/users/view_message').'/'.$user_infos[0]['user_id']; ?>">Inbox</a></li>
						<li><a href="<?php echo site_url('/users/feedback').'/'.$user_infos[0]['user_id']; ?>">My Feedback</a></li>
					</ul>
					...
					<?php } else { ?>
						<div id="inbox">
							...
							<?php } else { ?>	
									<tr>
										<td <td colspan="4" style="font-size: 1.2em; color: #EE3A43; text-align:center;" ><strong>No Message Found!.</strong></td>
									</tr>
							<?php } ?>	
									<td colspan="4" >
...
<script>
	function details_message(id,prop_id) {
		var div_id="#inbox_msg";
		 $.ajax({
	            type: "POST",
	            url: "<?php echo base_url()?>users/msg_details",
	            data: {msg_id: id }, // <---
	...
	function feedback_msg_details(id,prop_id) {
		var div_id="#feedback_msg";
		 $.ajax({
	            type: "POST",
	            url: "<?php echo base_url()?>users/feedback_details", // 
