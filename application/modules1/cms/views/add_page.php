...
<hr />
<br>
<form method="post" name="ckeditor_form" action="<?php echo site_url('cms/add_page');?>">
	...
	<div class="form-group" >
		...
		<textarea class="form-control ckeditor" data-stylesheet-url="assets/css/wysihtml5-color.css" name="content_it" style="height:300px;"></textarea>
	</div>
        
	<div class="form-group" >
            <label>Content In English</label>
		<textarea class="form-control ckeditor" data-stylesheet-url="assets/css/wysihtml5-color.css" name="content_en" style="height:300px;"></textarea>
	</div>
