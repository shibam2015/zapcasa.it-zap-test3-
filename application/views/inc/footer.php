<footer class="searchpage">
    	...
    	<div class="main">
        	<div class="footermenulist">
                ...
                <?php
					...
					{
				?>
                 <li><a href="<?php echo base_url();?>property/add_property_form" class="freepost add_property"><?php echo $this->lang->line('footer_place_a_free_advert');?></a></li>
				 <?php
				  }
	...
	<?php $followUs = get_all_value('zc_settings',"and meta_key_group='social_pages'"); ?>
