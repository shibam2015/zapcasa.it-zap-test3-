...
<div class="main">
	<header>
		<div class="logo">
			<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/logo.png" alt="Zapcasa"></a>
		</div>
		<div class="header_rightpanel">
								...
								<ul>
									<li>
										<a href="<?php echo base_url();?>property/get_message">
											<?php echo $this->lang->line('mainMenu-inbox');?>
											<sup class="count"><?php echo $mesg_cnt;?></sup>
										</a>
									</li>
									...
									<?php 
									/*<li><a href="<?php echo base_url();?>user/my_email_alerts">
									<?php echo $this->lang->line('mainMenu-myEmailAlert');?>
									</a>
									</li> */ ?>
									<li><a href="<?php echo base_url();?>users/my_account"><?php echo $this->lang->line('mainMenu-myAccount');?></a></li>
			...
			<div class="lanugage">
				<select class="custom" name="countriesFlag" id="countriesFlag">
					<option class="italy" <?php if( isset( $_COOKIE[ 'lang'] ) && ( $_COOKIE[ 'lang']=="it" )) { ?>selected="selected"
						<?php } ?> value="it" >
							<?php echo $this->lang->line('italian');?>
					</option>
					<option class="usa" <?php if( isset( $_COOKIE[ 'lang'] ) && ( $_COOKIE[ 'lang']=="english" )) { ?>selected="selected"
						<?php } ?> value="english" >
			...
			<div class="socail_topmenu">
				...
				<!-- Go to www.addthis.com/dashboard to customize your tools -->
				<!--<div class="addthis_sharing_toolbox"></div>--><span class='st_facebook'></span> <span class='st_twitter'></span> <span class='st_googleplus'></span> <span class='st_linkedin'></span> <span class='st_email'></span> <span class='st_sharethis'></span>
				<?php /* ?>
					<ul>
			...
			<nav>
				<?php        			?>
					<ul>
						...
						<li><a href="<?php echo base_url();?>property/search?category_id=1" <?php if(isset($search_title) && $search_title=='Residential' ){?> class='active'<?php }?>><?php echo $this->lang->line('mainMenu-residential');?></a></li>
						<li><a href="<?php echo base_url();?>property/search?category_id=2" <?php if(isset($search_title) && $search_title=='Business' ){?> class='active'<?php }?>><?php echo $this->lang->line('mainMenu-business');?></a></li>
						<li><a href="<?php echo base_url();?>property/search?category_id=3" <?php if(isset($search_title) && $search_title=='Rooms' ){?> class='active'<?php }?>><?php echo $this->lang->line('mainMenu-rooms');?></a></li>
						<li><a href="<?php echo base_url();?>property/search?category_id=4" <?php if(isset($search_title) && $search_title=='Land' ){?> class='active'<?php }?>><?php echo $this->lang->line('mainMenu-land');?></a></li>
						<li><a href="<?php echo base_url();?>property/search?category_id=5" <?php if(isset($search_title) && $search_title=='Vacations' ){?> class='active'<?php }?>><?php echo $this->lang->line('mainMenu-vacations');?></a></li>
						<li><a href="<?php echo base_url();?>property/search?category_id=10" <?php if(isset($search_title) && $search_title=='Luxury' ){?> class='active'<?php }?>><?php echo $this->lang->line('mainMenu-luxury');?></a></li>
					</ul>
			</nav>
		</div>
	</header>
