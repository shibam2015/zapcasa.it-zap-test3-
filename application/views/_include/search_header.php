...
function typology_adjustment(str){
	...
	if((str!=0)&&(str!="Business") && (str!="Luxury")){
		$.post("<?php echo base_url(); ?>property/getTypology",{lang : '<?php echo $_COOKIE['lang']; ?>', category : str,selected_typology:selected_typology},function(result){
...
$(document).ready( function() {
	...
	?>
	typology_adjustment('<?php echo $for_luxury; ?>');
	<?php
	}
	?>
});	
...
<?php
	...
	echo form_open_multipart('property/search', $attributes);
?>
<div class="searchbig">
	<input type="text" name="location" id="location" placeholder='<?php echo $this->lang->line('search_header_location_field');?>' value="<?php echo isset( $_GET['location'] ) ? $_GET['location'] : ''; ?>" autocomplete="off">
	<div id="suggesstion-box" style='overflow:auto;max-height:300px;position:absolute;z-index:10;width:220px;margin-top:32px;'></div>
</div>
<div class="multiplesearch">
	...
	if ( isset($segs) && ( count($segs) == 1 ) ) {
		...
		$catids=getCatByName($segs[1]);
		if($catids!='')
		{
			$cat_code =$catids[0]['category_id'];
		}else{
			$cat_code ='';
		}
	...
	<!-- <input type="hidden" id="category_id" name="category_id" value="<?php //echo isset( $_GET['category_id'] ) ? $_GET['category_id'] : 0; ?>"> -->
	<input type="hidden" id="category_id" name="category_id" value="<?php echo isset( $_GET['category_id'] ) ? $_GET['category_id'] : $this->session->userdata("category_code"); ?>" >
			...
			<ul>
				<li id="login">
					<a id="login-trigger" href="javascript:void(0);">
						...
						<span style="font-size:10px; padding-left:5px;">
							<?php echo '&#x25BC;';?>
						</span>
					</a>
								...
								<tbody>
									<tr>
										<td>
											...
											<span><?php echo($_COOKIE['lang']=='it'?$rs_status['name_it']:$rs_status['name']);?></span>
										</td>
			...
			<ul>
				<li id="login">
					...
					<div id="login-content2" class="dp-content">
						<div class="basic_div_part">
							<fieldset id="inputs">
								<input type="text" placeholder="<?php echo $this->lang->line('search_header_any_price_min');?>" name="min_price" id="min_price" value="<?php echo isset( $_GET['min_price'] ) ? $_GET['min_price'] : ''; ?>" class="groupOfCurrencyBox">
								<input type="text" placeholder="<?php echo $this->lang->line('search_header_any_price_max');?>" name="max_price" id="max_price" value="<?php echo isset( $_GET['max_price'] ) ? $_GET['max_price'] : ''; ?>" class="groupOfCurrencyBox">
							</fieldset>
						</div>
					</div>
				</li>
	...
	<div class="customsearch">
		...
		<div class="filter_id">
			<ul>
				<li id="login">
					<a id="login-trigger3" href="javascript:void(0);">
						<?php echo $this->lang->line('search_header_rooms_number');?>
						<span style="font-size:10px; padding-left:5px;">▼</span>
					</a>
					<div id="login-content3" class="dp-content">
						<div class="basic_div_part">
							<fieldset id="inputs">
								<input type="text" placeholder="<?php echo $this->lang->line('search_header_rooms_number_min');?>" name="min_room" id="min_room" value="<?php echo isset( $_GET['min_room'] ) ? $_GET['min_room'] : ''; ?>" class="groupOfTexbox2">
								<input type="text" placeholder="<?php echo $this->lang->line('search_header_rooms_number_max');?>" name="max_room" id="max_room" value="<?php echo isset( $_GET['max_room'] ) ? $_GET['max_room'] : ''; ?>" class="groupOfTexbox2">
							</fieldset>
						</div>
					</div>
				</li>
			...
			<ul>
				<li id="login">
					<a id="login-trigger4" href="javascript:void(0);">
						<?php echo $this->lang->line('search_header_typology');?>
						<span style="font-size:10px; padding-left:5px;">▼</span>
					</a>
					<div id="login-content4" class="dp-content">
						<div class="basic_div_part" style="overflow-y: scroll; height:200px;">
							<div id="typology">
								...
								?>
								<fieldset id="inputs">
									<select name="for_business" onchange="return typology_adjustment(this.value);" style="width:223px;">
										<option value=""><?php echo $this->lang->line('search_header_typology_business_select');?></option>
										<option value="PRO" <?php if(isset($for_luxury) && ("PRO" == $for_luxury || "Property" == $for_luxury || "Property for business" == $for_luxury || "Immobili commerciali" == $for_luxury)) { echo "selected"; }?> ><?php echo $this->lang->line('search_header_typology_business_property_for_business');?></option>
										<option value="BLI" <?php if(isset($for_luxury) && ("BLI" == $for_luxury || "Business license" == $for_luxury || "Licenze commerciali" == $for_luxury)) { echo "selected"; }?> ><?php echo $this->lang->line('search_header_typology_business_business_license');?></option>
									</select>
								</fieldset>
								<?php
								}
								...
								<fieldset id="inputs">
									<select name="for_luxury" onchange="return typology_adjustment(this.value);" style="width:223px;">
										...
										<option value="RES" <?php if(isset($for_luxury) && ("RES" == $for_luxury || "Residenziale" == $for_luxury || "Residential" == $for_luxury)){ echo "selected"; }?> ><?php echo $this->lang->line('search_header_typology_luxury_residential');?></option>
										<option value="PRO" <?php if(isset($for_luxury) && ("PRO" == $for_luxury || "Property" == $for_luxury || "Property for business" == $for_luxury || "Immobili commerciali" == $for_luxury)) { echo "selected"; }?> ><?php echo $this->lang->line('search_header_typology_luxury_property_for_business');?></option>
										<option value="BLI" <?php if(isset($for_luxury) && ("BLI" == $for_luxury || "Business license" == $for_luxury || "Licenze commerciali" == $for_luxury)) { echo "selected"; }?> ><?php echo $this->lang->line('search_header_typology_business_license');?></option>
										<option value="VAC" <?php if(isset($for_luxury) && ("VAC" == $for_luxury || "For vacations" == $for_luxury || "Vacations" == $for_luxury || "Vacanze" == $for_luxury)) { echo "selected"; }?> ><?php echo $this->lang->line('search_header_typology_luxury_vacations');?></option>
									</select>
								</fieldset>
								<?php
								}
	...
	<div class="customsearch">
		...
		<div class="filter_id">
			<ul>
				<li id="login">
					<a id="login-trigger5" href="javascript:void(0);">
						<?php echo $this->lang->line('search_header_more');?>
						<span style="font-size:10px; padding-left:5px;">▼</span>
					</a>
					<div id="login-content5" class="dp-content">
						...
						?>
						<div class="basic_div_part">
							<hr><?php echo $this->lang->line('search_header_show_only_with');?>
							<table width="100%">
								<?php
								if($search_title=='Rooms'){
								?>
								...
								<tr>
									<td>
										<span>
											<input type="checkbox" name="balcony" value="1" <?php if( isset( $_GET['balcony'] ) &&( $_GET['balcony'] == "1" ) ) { echo "checked"; }?> />
										</span> 
										<span>
											<?php echo $this->lang->line('search_header_balcony');?>
										</span>
									</td>
								</tr>
								<?php
	...
	<input type="hidden" name="ordering_opt" id="ordering_opt" value="order_latest">
	<?php echo form_close();?>
</div>
