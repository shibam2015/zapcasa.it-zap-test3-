...
.userGuideMAP {background: #f7f7f7 none repeat scroll 0 0;border: 1px solid #e5e3e3;color: #666666;float: left;font-weight: bold;margin: 50px 0 0;}
.userGuideMAP h2 {background: #b26363 none repeat scroll 0 0;color: #f7f7f7;font-size: 12px;padding: 5px 0;text-align: center;}
.userGuideMAP ul {list-style: outside none disc;margin: 0;padding: 10px 10px 10px 25px;}
.userGuideMAP li {padding: 10px 0 20px 5px;}
