							...
							if( $prop_id != 0 ) {
                                ...
                                <span>
                                    ...
                                    <div class="property_img">
										...
										<a <?php echo(($property_status == 2 && ($suspention_status == 0 && $user_status_list == 1 && $property_approval != '0')) ? 'href="' . str_replace("\'", "", $parms_url) . '"' : 'style="color:#686868;"'); ?>>
                                    ...
                                    <div class="property_cont">
										...
										<h4 style="font-size:15px;">
											...
											<a <?php echo(($property_status == 2 && ($suspention_status == 0 && $user_status_list == 1 && $property_approval != '0')) ? 'href="' . str_replace("\'", "", $parms_url) . '"' : 'style="color:#999999;"'); ?>>
									...
									<td>
										...
										<input type="hidden" id="saved_<?php echo $property_list['saved_id'] ?>"
											   value="<?php echo str_replace("\'", "", $parms_url); ?>">
