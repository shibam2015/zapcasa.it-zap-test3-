            ...
            <div class="left_panel">
                ...
                <div class="advertiser_details">
                    <div class="prop_panel" id="property_listing">
						...
						//$getFeaturedProperty = getFeaturedPropertyDetails();
						//$featuredCount = count($getFeaturedProperty);
                        ...
                        <h2>
							...
							<span style="float:right;color:#888888;font-weight:normal;font-size:12px;">
								...
								//echo $totalPublishedPropertyList + $totalHightlightedPropertyList;
                        ...
                        <ul class="property-info">
                            <li id="pub_prop" <?php echo($this->uri->segment(3) == "property_list"?'class="active"':'');?>>
								<a href="javascript: void(0);" onClick="return publish_prop()">
                            ...
                            <li id="draft_prop" <?php echo($this->uri->segment(3) == "draft_property_list"?'class="active"':''); ?>>
								<a href="javascript: void(0);" onClick="return draft_prop()">
									<?php echo $this->lang->line('property_details_draft');?> 
									<span>(<?php echo $totalDraftedPropertyList; ?>)</span>
								</a>
							</li>
                            <li id="high_prop">
								<a href="javascript: void(0);" onClick="return highlight_prop()">
										...
										<div style="display:table">
											<div style="display:table-cell;width:150px;vertical-align:top;">
												<div style="display:table">
													...
													<div style="display:table-cell;vertical-align:middle;">
														<a <?php echo(($suspended_user_type != 4 || $property_lists['suspention_status'] == 0)?'href='.base_url().'property/edit_property/'.$property_id:'href="javascript: void(0);" id="suspend_property_by_admin"'); ?>>
														<?php
											...
											<div style="display:table-cell;vertical-align:top;">
												...
												<h2 style="display:table;width:100%;">
													<a style="display:table-cell;vertical-align:middle;" <?php echo(($suspended_user_type != 4 || $property_lists['suspention_status'] == 0)?'href='.base_url().'property/edit_property/'.$property_id:'href="javascript: void(0);" id="suspend_property_by_admin"'); ?>>
														<?php
						...
						if(count($getFeaturedProperty)> 0 ){
							...
							<div style="color:#ed6b1f;padding:5px 0px 5px 15px;background:#f2e8e8;font-weight:bold;font-size:12px;">
								You can't delete or edit the properties in this section until the end of the planning
							</div>
                                ...
                                <li>
                                    <div class="last_property" style="padding:10px 0 0 0;<?php echo($suspended_user_type != 4 || $property_lists_featured['suspention_status'] == 0?'':'background:#FFFFD7'); ?>">
										...
										<div style="display:table;width:100%;background:rgba(0, 0, 0, 0.08);margin-top:10px;">
											...
											$hightlightedDay = floor($diff/(24*60*60));
											?> 
											<div style="display:table-cell;vertical-align:middle;padding-left:5px;">												
												<?php
