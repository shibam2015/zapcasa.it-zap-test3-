...
class CategoryHelpers {
	...
	public static function getMarker($marker = '', $format_value = false, $category_id = 0) {
		$default_marker = base_url().'/assets/images/MapMarker_Marker_Outside_Pink.png';

		if($category_id > 0 && $marker == '') {
			if( $category_id == '2') {
				$marker = base_url().'assets/images/orenge_mark.png';
				//$marker = '/-custom/MapMarker_Flag4_Left_Pink.png';
			} else if( $category_id == '1') {
				$marker = base_url().'assets/images/blue_mark.png';
		...
		return ($format_value) ? $marker : $default_marker;
    }
