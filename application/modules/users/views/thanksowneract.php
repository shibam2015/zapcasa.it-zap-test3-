...
<div class="main">
	<div id="breadcrumb" class="fk-lbreadbcrumb newvd">
    	<span><a href="<?php echo base_url();?>"><?php echo $this->lang->line('thanks_owner_act_home');?></a></span> >  
        <span><a href="<?php echo base_url();?>users/common_reg"><?php echo $this->lang->line('thanks_owner_act_register');?></a></span> >
        <span><a href="<?php echo base_url();?>users/reg_owner"><?php echo $this->lang->line('thanks_owner_act_sign_up_as_owner');?></a></span> >
        <span><?php echo $this->lang->line('thanks_owner_act_thanks');?></span>
    </div>
	<div class="registercomn_box">
    	...
    	<div class="mainsucc_box">
            <div class="suceesfulbox">
                ...
                <span>
                    <h1><?php echo $this->lang->line('thanks_owner_act_congratulations');?></h1>
					<p><?php echo $this->lang->line('thanks_owner_act_your_account_successfully_activated');?></p>
                </span>    
            </div>
            <div style="margin-left:39%;margin-bottom:20px;float:left;">
                <a class="mainbt topopup" href="javascript:void(0);"><?php echo $this->lang->line('thanks_owner_act_signin');?></a> 
            </div>
        </div>
    </div>
</div>
