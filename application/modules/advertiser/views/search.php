							...
							<div class="listingContent">
								...
								<div class="propFeatures">
									...
									<h3><?php echo $this->lang->line('advertise_list_property_post');?> <font
											style="color:#ED6B1F"><?php echo get_perticular_count('zc_property_details', " and property_post_by='" . $arrAdv->user_id . "' AND property_status='2' AND suspention_status='0' AND property_approval ='1'");?></font>
									</h3>
