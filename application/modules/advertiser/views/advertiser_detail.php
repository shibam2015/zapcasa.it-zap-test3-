	...
	<div class="advertiser_details">
        <h2 class="searchfound"> 
	        <span class="post_brn">
					...
					?> 
	                	<a href="<?php echo base_url();?>property/add_property_form" class="freepost"><?php echo $this->lang->line('advertise_details_post_your_property');?> <font style="color:#fff000"><?php echo $this->lang->line('advertise_details_free');?></font></a>
	                <?php
					  } if($user_type=='1') {
					?> 
	                   	<a href="<?php echo base_url();?>property/add_property_form" class="freepost add_property"><?php echo $this->lang->line('advertise_details_post_your_property');?> <font style="color:#fff000"><?php echo $this->lang->line('advertise_details_free');?></font></a>
	                <?php
					  } if($this->session->userdata( 'user_id' )=='0'  || $this->session->userdata( 'user_id' )=='' ) {
					?>
	                 	<a href="<?php echo base_url();?>users/common_reg" class="freepost"><?php echo $this->lang->line('advertise_details_post_your_property');?> <font style="color:#fff000"><?php echo $this->lang->line('advertise_details_free');?></font></a>
	                <?php
					  }
					?>
	         </span>
		...
		?>
            ...
            <ul>
            	<li><a id="show_image" href="javascript:void(0);" class="active" onClick="show_image();" ><?php echo $this->lang->line('advertise_details_image_view');?></a></li>
				<?php 
            ...
            <div id="image_view">
            		<?php
					  ...
					  {
					?>
            	<div id="image_view" style="background: url(<?php echo base_url();?>assets/uploads/thumb_92_82/<?php echo $advertiser_detail[0]['file_2']; ?>) 50% no-repeat #ffffff;background-size:contain;">
                     ...
                     <?php
					  ...
					  {
					 ?>
            	<div id="image_view" style="background: url(<?php echo base_url();?>assets/images/<?php echo $this->lang->line('advertise_details_no_proimg_filename');?>) 50% no-repeat #ffffff;background-size:contain;">
                      <img src="<?php echo base_url();?>assets/images/alpha_10x10.png" >
                </div>
                     <?php
					  }
            ...
            <?php } ?>
        		...
        		?>
        				<img src="<?php echo base_url();?>assets/uploads/thumb_92_82/<?php echo $advertiser_detail[0]['file_1']; ?>" alt="<?php echo $business_name; ?>">
                	<?php
        		 	 } else {
        			?>  
        				<img src="<?php echo base_url();?>assets/images/no_prof.png" alt="<?php echo $business_name; ?>">
        		<?php 
        			}
        		}
                  if($advertiser_detail[0]['user_type']=='3') {
        		...
        		?> 
                 	<h2 class="company_name"><?php echo ucfirst($advertiser_detail[0]['first_name']);?>&nbsp;<?php echo ucfirst($advertiser_detail[0]['last_name']);?></h2>
                <?php
        		  }
        		?>
                	</div>
        		                   ...
        		                   <?php
        							  	if($advertiser_detail[0]['user_type']=='3') {
        		                    		if($advertiser_detail[0]['contact_ph_no']!='') {
        										...
        										if( $advertiser_detail[0]['phone_1'] != "" ) { echo $advertiser_detail[0]['phone_1']; } else { echo $this->lang->line('advertise_details_contact_not_available'); }	
        								  }
        							?>
        							<?php 
        	                    	...
        	                    	<li class="mail"><?php if( $advertiser_detail[0]['email_id'] != "" ) { echo $advertiser_detail[0]['email_id']; } else { echo $this->lang->line('advertise_details_contact_not_available'); } ?></li>
                            <?php }
        					  if($advertiser_detail[0]['user_type']=='3') {
        					?> 
         ...
         <!--property posted by owner/agency--> 
			...
			if(!empty($property_list)){
				foreach($property_list as $property_lists){	
					...
					$prop_det_url.='-'.trim($property_lists['city']);
					$prop_det_url.='-'.trim($property_lists['provience']);
                	...
                	<div class="last_property" style="display:table;width:100%;">
                    	...
                    	<div style="display:table-cell;vertical-align:top;width:110px;height:80px;">
							...
							<a href="<?php echo base_url();?><?php echo $first_segment;?>/<?php echo $prop_det_url;?>">
                                <img src="<?php echo base_url();?>assets/uploads/Property/Property<?php echo $property_id;?>/thumb_200_296/<?php echo $main_img;?>" alt="<?php echo stripslashes($proptitle); ?>" width="102px" height="68px;">
                            </a>
							<?php
							} else {
							?>
							<a href="<?php echo base_url();?><?php echo $first_segment;?>/<?php echo $prop_det_url;?>">
								<img src="<?php echo base_url();?>assets/images/no_img_small.png" alt="<?php echo stripslashes($proptitle); ?>" width="102px" height="68px;">
                            </a>
							<?php
							}
							?>
						...
						<div style="display:table-cell;vertical-align:top;">
							...
							<h3>
								...
								?>
								<?php if($property_lists['street_address']!=''){echo $property_lists['street_address'].',';} ?>
								<?php if($property_lists['street_no']!=''){echo $property_lists['street_no'].' - ';} ?>
								<?php if($property_lists['zip']!=''){echo $property_lists['zip'];} ?>
							</h3>
							<?php
			  ...
			  ?> 
              <li>
              	<div class="last_property"><?php echo $this->lang->line('advertise_details_no_property_found');?></div>
              </li>
              <?php
			}
			  ?> 
        ...
        <div class="right_panel">
			...
			?>
	          	<div class="advertiser_form">
	           		<div class="field"> <input type="hidden" placeholder="<?php echo $this->lang->line('advertise_details_your_name_field');?>" name="name" id="name" value="<?php echo $name;?>"> </div>                  
	          		<div class="field"> <input type="hidden" placeholder="<?php echo $this->lang->line('advertise_details_email');?>" name="email_id" id="email_id" value="<?php if( $user_pref[0]['my_contact_info'] != 1 ) { echo $email_id; } ?>"> </div>      
		         	 <div class="field"> <input type="text" placeholder="<?php echo $this->lang->line('advertise_details_subject');?>" name="subject" id="subject" value="" > </div>      
		             <div class="field"> <textarea rows="3" cols="15" placeholder="<?php echo $this->lang->line('advertise_details_message');?>" name="message" id="message"></textarea> </div>   
		            ...
		            <?php
		              if($this->session->userdata( 'user_id' )=='0' || $this->session->userdata( 'user_id' )=='') {
					?> 
		                	<a herf="javascript:void(0);" class="contact_agent"><?php echo $this->lang->line('advertise_details_send');?></a>
		                <?php
						} else {
					?>  
          ...
          <div class="feedback"><a href="#Fform" id="open_feedback" onClick="return open_feedback_form();"><?php echo $this->lang->line('advertise_details_leave_feedback');?></a></div>
          ...
          <h2><?php echo $this->lang->line('advertise_details_give_feedback');?></h2>
           ...
           $uid=$this->session->userdata( 'user_id' );
            ...
            <div class="field"> <input <?php if($uid !='' || $uid !='0') { ?> type="hidden" <?php } else { ?> type="text" <?php } ?> placeholder="<?php echo $this->lang->line('advertise_details_feedback_your_name_field');?>" name="name" id="name" value="<?php echo $name;?>"> </div>        
          	<div class="field"> <input <?php if($uid !='' || $uid !='0') { ?> type="hidden" <?php } else { ?> type="text" <?php } ?> placeholder="<?php echo $this->lang->line('advertise_details_feedback_your_email_field');?>" name="email_id" id="email_id" value="<?php echo $email_id;?>"> </div> 

         	 <div class="field"> <input type="text" placeholder="<?php echo $this->lang->line('advertise_details_feedback_subject_field');?>" name="subject" id="subject" value="" > </div>      
             <div class="field"> <textarea rows="3" cols="15" placeholder="<?php echo $this->lang->line('advertise_details_feedback_your_feedback_field');?>" name="message" id="message"></textarea> </div>   
             
             <?php if($uid=='' || $uid=='0') { ?>
					<div style="float:left; width:100%; margin-top:12px;">
		            	<label style="float:left; width:5%; margin-top:5px; "><input name="agree_terms" type="checkbox" value="1"  class="required" ></label><p style="float:left; width:95%"><?php echo $this->lang->line('reg_user_I_have_read_and_agree_adviser');?><a href="<?php echo base_url();?>site/cmsPages/privacy"><?php echo $this->lang->line('reg_user_owner_privacy_policy');?></a></p>
		                <br/>
		                <label class="error" style="color:red;" for="agree_terms" generated="true"></label>
		            </div>
		            <div style="float:left; width:100%; margin-top:12px;">
		            	<label style="float:left; width:5%; margin-top:5px; "><input name="receive_mail" type="checkbox" value="1" ></label><p style="float:left; width:95%"><?php echo $this->lang->line('reg_user_wish_to_receive_informations_adviser');?></p>
		            </div>
			<?php } ?>
                ...
                <input type="hidden" name="property_id" value="0">
				<div class="field">
            		<input type="submit" value="<?php echo $this->lang->line('advertise_details_button_submit_feedback');?>" onClick="return form_validation_feedback();">
                <?php
                	echo form_close();
				?>
              </div>  
...
$(function() {
 ...
 <?php
		...
		?>
					...
					if( $advertiser_detail[0]['street_address'] ) { $addressStr = str_replace("'","\'",$advertiser_detail[0]['street_address'])."<br/>,"; }
				  			if( $advertiser_detail[0]['street_no'] ) { $addressStr .=  $advertiser_detail[0]['street_no']; }
				  			if( $advertiser_detail[0]['zip'] ) { $addressStr .= ' - '.$advertiser_detail[0]['zip']; }
				  			if( $advertiser_detail[0]['city'] ) { $addressStr .= ' '.str_replace("'","\'",$advertiser_detail[0]['city']); }
				  			if( $st_name1 != "" ) { $addressStr .= ' - '.$st_name1; } 
				  		?> 
	                </p>
         <?php
         		}
		...
		var centerZoom = 5;
		var centerLatitude = <?php echo(!empty($GoogleMapMarkersLatitude)?$GoogleMapMarkersLatitude:'42.500000'); ?>;
		var centerLongitude = <?php echo(!empty($GoogleMapMarkersLongitude)?$GoogleMapMarkersLongitude:'12.500000'); ?>;
		var map;
		var infowindow = null;
		var gmarkers = [];
		var markerTitles = [];
		...
		GoogleMapMarkers.push(["<?php echo $business_name; ?>","markers",<?php echo $GoogleMapMarkersLatitude; ?>,<?php echo $GoogleMapMarkersLongitude; ?>,"<?php echo $advertiserAddress; ?>","javascript:void(0);",'',"<?php echo $advertiserImage; ?>", "advDetails"]);		
