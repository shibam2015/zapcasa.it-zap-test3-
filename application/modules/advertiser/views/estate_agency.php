	                    ...
	                    <?php if( $user_pref[0]['my_address_display'] == 0 ) {  ?>
		                    ...
		                    <div class="listAddress">
								...
								<h4>
									...
									<?php $st_name2=get_perticular_field_value('zc_region_master','province_code'," and `province_name_it` LIKE '%".$arrAdv['province']."%' group by province_code");
									...
									?>
							  		...
							  		<?php 
							  			...
							  			if( $st_name2 != "" && $st_name1 == "") { echo ' - '.$st_name2;} 
		...
		<?php
				...
				$propertyAddress .= ($arrAdv['street_address'] != '' ? $arrAdv['street_address'] . ', ' : '');
					...
					$propertyShowingAddress .= ($arrAdv['zip'] != '' ? ' - ' . $arrAdv['zip'] : '');
						...
						$advertiserGeoAddress1 .= $ShowingProvinceCode;

						 // echo "<pre>";

			    // print_r($advertiserGeoAddress1);exit;
