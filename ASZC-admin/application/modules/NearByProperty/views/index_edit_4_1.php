...
<div class="main-content">
    ...
    <div class="form-group">
        ...
        <select name="province" id="province" class="required form-control" onChange="return get_city(this.value);">
            ...
            foreach ($provience_list as $key => $val) {
                ...
                <option
                    value="<?php echo $val; ?>" <?php if ($val == set_value('province')) { ?> selected <?php } ?>><?php echo $val; ?>
        ...
        <select name="city" id="city" class="required form-control">
            ...
            <?php
                ...
                foreach ($city as $key => $val) {
                    ...
                    <option
                        value="<?php echo $val;?>" <?php if ($val == set_value('city')) { ?> selected <?php }?>><?php echo $val;?></option>
    ...
    <div class="form-group">
        ...
        <input type="text" placeholder="Enter your Street address" id="street_address" name="street_address" value=""
