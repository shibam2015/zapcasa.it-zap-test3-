...
<hr />
	...
	if ($property_details[0]['url'] != "") {
		$propertyImage = base_url() . "assets/uploads/Property/Property" . $property_details[0]['property_details_id'] . "/thumb_92_82/" . $property_details[0]['url'];
	}
				...
				<div class="add_newproperty_table1" style="width:100%;">
					...
					<div class="section2" style="border-top:1px solid #cccccc">
						...
						<div class="cat_select">
							...
							<input type="hidden" name="locupdatefor" value="<?php echo $property_details[0]['property_details_id']; ?>">
