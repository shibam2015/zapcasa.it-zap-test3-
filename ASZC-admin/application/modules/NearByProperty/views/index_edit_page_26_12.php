...
<div class="main-content">
        ...
        <select name="category_id" id="category_id" class="form-control">
            ...
            if (count($category_list) > 0) {
                ...
                foreach ($category_list as $key) {
                    ...
                    <option
                        value="<?php echo $key['category_id']; ?>" <?php if ($result[0]->category_id == $key['category_id']) { ?> selected="selected" <?php } ?>>
    ...
    <div class="form-group">
        ...
        <input type="text" name="opt_name" id="opt_name" class="form-control"
               value="<?php echo $result[0]->opt_name; ?>"/>
    ...
    <div class="form-group">
        ...
        <select name="province" id="province" class="required form-control" onChange="return get_city(this.value);">
            ...
            foreach ($provience_list as $key => $val) {
                ...
                <option
                    value="<?php echo $val; ?>" <?php if (strtolower(trim($val)) == strtolower(trim($result[0]->provience))) { ?> selected <?php } ?>><?php echo $val; ?>
                    - <?php echo $st_name1; ?></option>
        ...
        <select name="city" id="city" class="required form-control">
            ...
            <?php
                ...
                foreach ($city as $key => $val) {
                    ...
                    <option
                        value="<?php echo $val;?>" <?php if ($val == $result[0]->city) { ?> selected <?php }?>><?php echo $val;?></option>
    ...
    <div class="form-group">
        ...
        <input class="required form-control" placeholder="Enter your Zip code" type="text" name="zip" id="zip"
               value="<?php echo $result[0]->zip; ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" placeholder="Enter your Street address" id="street_address" name="street_address"
               value="<?php echo $result[0]->street_address; ?>" class="required form-control">
    ...
    <div class="form-group">
        ...
        <input type="text" name="street_no" placeholder="Enter your Street No"
               value="<?php echo $result[0]->street_no; ?>" class="form-control">
    ...
    <div class="form-group" style="overflow:hidden;">
        ...
        <div style="float: right; text-align: left; width: 79.8%;">
            ...
            <img id="img_1" src="<?php if ($result[0]->url == "") {
                ...
                echo base_url() . 'assets/uploads/NearByProperty/' . $result[0]->url;
