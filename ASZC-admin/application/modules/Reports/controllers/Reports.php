...
class Reports extends CI_Controller {
	...
	public function property_wise() {
		...
		/*------------*/
		$data['agencise_publish_properties']=$this->Reports_model->agencise_publish_properties(3);
		$data['owner_publish_properties']=$this->Reports_model->agencise_publish_properties(2);
		//$data['owner_publish_properties']=$this->Reports_model->agencise_publish_properties(2);
		/*--------------*/
		if( count( $result ) > 0 ) {
		...
		$data['agency_saved_property']=$this->Reports_model->agency_saved_property(3);
		$data['owner_saved_property']=$this->Reports_model->agency_saved_property(2);
	...
	public function active_user_report() {
		...
		$this->load->view('active_user_report', $data);
	}
