...
#		echo "===========".$this->db->last_query(); exit;
	...
	function update_featured_status($new_data)
	{

		$usql = "update zc_property_details set feature_status='0' where property_id='" . $new_data['property_id'] . "'";
	...
	function resume_featured_entry_new($property_id)
	{
		$sql = "update zc_property_details set feature_status='0',suspention_status ='0' where property_id='" . $property_id . "'";
		$this->db->query($sql);
		$dsql = "Delete from zc_property_featured where property_id='" . $property_id . "'";
		return $this->db->query($dsql);
	}
