...
<div class="main-content">
	...
	$image_path = get_perticular_field_value('zc_property_img', 'file_name', " and property_id='" . $property_details[0]['property_id'] . "' AND img_type='main_image'");
			...
			<div class="add_newproperty_table1" style="width:100%;">
					...
					<div class="section2" style="border-top:1px solid #cccccc">
						...
						<div class="cat_select">
							...
							<label style="display:block;">
								...
								<font
									...
									style="color:#f33038;">*</font>Latitude
						...
						<div class="cat_select">
							...
							<label style="display:block;">
								...
								<font
									...
									style="color:#f33038;">*</font>Longitude
						...
						<div class="cat_select" style="width:245px; margin-top:22px;">
							...
							<input type="submit" value="Save Position" name="btnSubmit" class="mainbt"
								   style="margin-right:0;">

							<input type="submit" value=" SKIP" name="btnSubmit" class="mainbt"
