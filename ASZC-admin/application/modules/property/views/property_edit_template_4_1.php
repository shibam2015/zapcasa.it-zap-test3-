...
<style>
    ...
    .btn-success.suspended {
        background-color: #ff9600;
        color: #000000;
    }

    .btn-success.suspended.btn-icon i {
    ...
    .btn-success.inactive.btn-icon i {
    ...
    .propertyName .title h5 {
        font-size: 12px;
        font-weight: bold;
        margin: 0;
    }

    .propertyName .title h6 {
        margin: 0;
    }

    .propertyName .title p {
        color: #999999;
        margin: 0;
    }
</style>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-8 clearfix">
                ...
                <div class="modal-dialog" style="opacity:1;position:fixed;top:450px;left:375px;">
                    <div class="modal-content">
                            ...
                            <form class="BlockedProFrm" action="" method="post">
                                <div class="col-md-12">
                                    <div class="form-group no-margin">
                                        <label class="control-label blcknt" for="field-7">Property Suspended
                                            Note</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="proSusModalClose();"
            ...
            <a class="btn btn-default editbtn btn-sm btn-icon btn-xs" style="width:120px;" title="Click here to edit"
               href="<?php echo base_url(); ?>user/edit_profile/<?php echo $property_details[0]['property_post_by']; ?>">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <div class="cat_select">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select disabled name="contract" id="contract" onChange="get_category(this.value);"
                            ...
                            foreach ($contract_type as $keyContract => $valContract) {
                                ?>
                                <option
                                    value="<?php echo $keyContract; ?>" <?php echo($property_details[0]['contract_id'] == $keyContract ? 'selected' : ''); ?>>
                ...
                <div class="cat_select" name="category_id" id="category_id">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select disabled name="category" id="category"
                                onChange="get_sub_category(this.value);typology_adjustment(this.value);display_things(this.value);"
                                class="form-control required">
                ...
                <div class="cat_select" style="display:none;" id="sub_category_area">
                    ...
                    <div class="col-sm-3">
                        <label class="error" for="sub_category" generated="true"
                               style="display:none;font-weight:normal"></label>
                        <select name="sub_category" id="sub_category" onChange="typology_adjustment(this.value);"
                                class="form-control required">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="province" id="province" class="form-control required"
                            ...
                            foreach ($provience_list as $key => $val) {
                                ...
                                <option
                                    value="<?php echo $provinceID;?>" <?php echo($provinceID == $property_details[0]['provience'] ? 'selected' : ''); ?>>
                ...
                <div class="cat_select">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input class="form-control required" placeholder="Enter your Zip code" type="text" name="zip"
                               id="zip" value="<?php echo $property_details[0]['zip']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="cat_select">
                    ...
                    <div class="col-sm-3">
                        <label class="error" for="address" generated="true"
                               style="display:none;font-weight:normal"></label>
                        <input type="text" placeholder="Enter your Street Name" id="address" name="address"
                               value="<?php echo $property_details[0]['street_address']; ?>"
                               class="form-control required">
                    </div>
                </div>
                <div class="cat_select">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="street_no" placeholder="Enter your Street No"
                               value="<?php echo $property_details[0]['street_no']; ?>" class="form-control">
                    </div>
                </div>
                <div class="cat_select">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="area" placeholder="District, Neighbourhood..."
                               value="<?php echo $property_details[0]['area']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="cat_select">
                    ...
                    <div class="col-sm-4">
                        <label id="special_err_price" class="error" for="input_price" generated="true"
                               style="display:none;font-weight:normal"></label>
                        <?php $price = number_format($property_details[0]['price'], 2, ',', '.'); ?>
                        <input type="text" name="price" placeholder="In EUR (eg. 1.000,00) 1.000.000,00)"
                               id="input_price" onKeyPress="return unchecked_radio();"
                               class="form-control required number groupOfCurrencyBox" value="<?php echo $price; ?>">
                    </div>
                </div>
                <div class="cat_select">
                    ...
                    <div class="col-sm-4" style="padding-top:6px;">
                        <input type="radio" name="pvt_negotiation" id="pvt_negotiation" onClick="return blank_text();"
                               value='1' <?php echo($property_details[0]['private_nagotiation'] == 1 ? 'checked' : ''); ?>>
                        &nbsp;&nbsp;Private nagotiation
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="cat_select">
                    ...
                    <div class="col-sm-8">
                        <input type="text" placeholder="Enter the property related YouTube Url" name="url" id="url"
                               value="<?php echo $property_details[0]['youtube_url']; ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="status_of_property" id="status_of_property" class="form-control required">
                            ...
                            foreach ($status_of_property as $stspro) {
                                ?>
                                <option
                                    value="<?php echo $stspro['id']; ?>" <?php echo($stspro['id'] == $property_details[0]['status'] ? 'selected' : ''); ?>>
                    ...
                    <div class="col-sm-4">
                        <select name="kind_of_property" id="kind_of_property" class="form-control">
                            ...
                            foreach ($kind_of_property as $kindpro) {
                                ?>
                                <option
                                    value="<?php echo $kindpro['id']; ?>" <?php echo($kindpro['id'] == $property_details[0]['kind'] ? 'selected' : ''); ?>>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="energy_efficiency" id="energy_efficiency" class="form-control required">
                            ...
                            foreach ($energy_efficiency_class as $energyeffpro) {
                                ?>
                                <option
                                    value="<?php echo $energyeffpro['id']; ?>" <?php echo($energyeffpro['id'] == $property_details[0]['energyclass'] ? 'selected' : ''); ?>>
            ...
            <div class="main_feature" style="display:none;">
                <div class="form-group">
                    <div class="cat_select" id="surface_area">
                        ...
                        <div class="col-sm-2">
                            <label class="error" for="surface_area" generated="true"
                                   style="display:none;font-weight:normal"></label>
                            <input type="text" name="surface_area" id="add_surface_area"
                                   class="form-control required number"
                                   value="<?php echo $property_details[0]['surface_area']; ?>">
                        </div>
                    </div>
                    <div class="cat_select" id="room_no">
                        ...
                        <div class="col-sm-2">
                            <label class="error" for="room_no" generated="true"
                                   style="display:none;font-weight:normal"></label>
                            <input type="text" name="room_no" id="add_room_no" class="form-control required number"
                                   value="<?php echo $property_details[0]['room_no']; ?>">
                        </div>
                    </div>
                    <div class="cat_select" id="floor">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="floor" id="room_floor" class="form-control"
                                   value="<?php echo $property_details[0]['floor']; ?>">
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <br>
                    ...
                    <div class="cat_select" id="tot_floor">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="tot_floor" id="tot_room_floor" class="form-control number"
                                   value="<?php echo $property_details[0]['total_of_floors']; ?>">
                        </div>
                    </div>
                    <div class="cat_select" id="year_of_building">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="year_of_building" id="Y_o_b" class="form-control number"
                                   value="<?php echo $property_details[0]['year_of_building']; ?>">
                        </div>
                    </div>
                    <div class="cat_select" id="bed_no">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="bed_no" class="form-control number" id="room_bed_no"
                                   value="<?php echo $property_details[0]['beds_no']; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group" id="row4">
                    <div class="cat_select" id="bothroom_no">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="bothroom_no" id="add_bathroom_no" class="form-control required">
                                ...
                                <option
                                    value="No" <?php echo($property_details[0]['bathrooms_no'] == 'No' ? 'selected' : ''); ?>>
                                    No
                                </option>
                                <option
                                    value="1" <?php echo($property_details[0]['bathrooms_no'] == '1' ? 'selected' : ''); ?>>
                                    1
                                </option>
                                <option
                                    value="2" <?php echo($property_details[0]['bathrooms_no'] == '2' ? 'selected' : ''); ?>>
                                    2
                                </option>
                                <option
                                    value="3" <?php echo($property_details[0]['bathrooms_no'] == '3' ? 'selected' : ''); ?>>
                                    3
                                </option>
                                <option
                                    value=">3" <?php echo($property_details[0]['bathrooms_no'] == '>3' ? 'selected' : ''); ?>>
                    ...
                    <div class="cat_select" id="kitchen">
                        ...
                        <div class="col-sm-2">
                            <label class="error" for="add_kitchen" generated="true"
                                   style="display:none;font-weight:normal"></label>
                            <select name="kitchen" id="add_kitchen" class="form-control required">
                                <option value="">Select</option>
                                <option
                                    value="No" <?php echo($property_details[0]['kitchen'] == 'No' ? 'selected' : ''); ?>>
                                    No
                                </option>
                                <option
                                    value="Kitchenettes" <?php echo($property_details[0]['kitchen'] == 'Kitchenettes' ? 'selected' : ''); ?>>
                                    Kitchenettes
                                </option>
                                <option
                                    value="Livable" <?php echo($property_details[0]['kitchen'] == 'Livable' ? 'selected' : ''); ?>>
                                    Livable
                                </option>
                                <option
                                    value="Living" <?php echo($property_details[0]['kitchen'] == 'Living' ? 'selected' : ''); ?>>
                                    Living
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="cat_select" id="heating">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="heating" id="add_heating" class="form-control required">
                                <option value="">Select</option>
                                <option
                                    value="No"<?php echo($property_details[0]['heating'] == 'No' ? 'selected' : ''); ?>>
                                    No
                                </option>
                                <option
                                    value="Autonomous" <?php echo($property_details[0]['heating'] == 'Autonomous' ? 'selected' : ''); ?>>
                                    Autonomous
                                </option>
                                <option
                                    value="Centralized" <?php echo($property_details[0]['heating'] == 'Centralized' ? 'selected' : ''); ?>>
                                    Centralized
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="cat_select" id="parking">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="parking" class="form-control required" id="add_parking">
                                <option value="">Select</option>
                                <option
                                    value="No" <?php echo($property_details[0]['parking'] == 'No' ? 'selected' : ''); ?>>
                                    No
                                </option>
                                <option
                                    value="Cargarage" <?php echo($property_details[0]['parking'] == 'Cargarage' ? 'selected' : ''); ?>>
                                    Car garage
                                </option>
                                <option
                                    value="Parking" <?php echo($property_details[0]['parking'] == 'Parking' ? 'selected' : ''); ?>>
                                    Parking
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="cat_select" id="roommates">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="roommates" id="add_roommates" class="form-control required">
                                <option value="">Select</option>
                                <option
                                    value="Only women" <?php echo($property_details[0]['roommates'] == 'Only women' ? 'selected' : ''); ?>>
                                    Only women
                                </option>
                                <option
                                    value="Only Men" <?php echo($property_details[0]['roommates'] == 'Only Men' ? 'selected' : ''); ?>>
                                    Only Men
                                </option>
                                <option
                                    value="Men and women" <?php echo($property_details[0]['roommates'] == 'Men and women' ? 'selected' : ''); ?>>
                                    Men and women
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="cat_select" id="occupation">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="occupation" id="add_occupation" class="form-control required">
                                <option value="">Select</option>
                                <option
                                    value="Only students" <?php echo($property_details[0]['occupation'] == 'Only students' ? 'selected' : ''); ?>>
                                    Only students
                                </option>
                                <option
                                    value="Only workers" <?php echo($property_details[0]['occupation'] == 'Only workers' ? 'selected' : ''); ?>>
                                    Only workers
                                </option>
                                <option
                                    value="Students and workers" <?php echo($property_details[0]['occupation'] == 'Students and workers' ? 'selected' : ''); ?>>
                    ...
                    <div class="cat_select" id="furnished">
                        ...
                        <div class="col-sm-2">
                            ...
                            <select name="furnished" id="add_furnished" class="form-control required">
                                <option value="">Select</option>
                                <option
                                    value="No" <?php echo($property_details[0]['furnished'] == 'No' ? 'selected' : ''); ?>>
                                    No
                                </option>
                                <option
                                    value="Yes" <?php echo($property_details[0]['furnished'] == 'Yes' ? 'selected' : ''); ?>>
                                    Yes
                                </option>
                                <option
                                    value="Partly" <?php echo($property_details[0]['furnished'] == 'Partly' ? 'selected' : ''); ?>>
                                    Partly
                                </option>
                            </select>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3" style="padding-top:6px;">
                        ...
                        <input type="radio" name="availabilty" id="avail_sp" class="required"
                               value='0' <?php echo($property_details[0]['availability'] == '0' ? 'checked' : ''); ?>>
                        &nbsp;Vacent&nbsp;&nbsp;
                        <input type="radio" name="availabilty" id="avail_sp" class="required"
                               value='1' <?php echo($property_details[0]['availability'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;Occupated
                    </div>
                    <div id="smokers">
                        ...
                        <div class="col-sm-3" style="padding-top:6px;">
                            ...
                            <input type="radio" name="smokers" id="smokers_space" class="required"
                                   value="0" <?php echo($property_details[0]['smokers'] == '0' ? 'checked' : ''); ?>>
                            &nbsp;Allowed&nbsp;&nbsp;
                            <input type="radio" name="smokers" id="smokers_space" class="required"
                                   value="1" <?php echo($property_details[0]['smokers'] == '1' ? 'checked' : ''); ?>>
                            &nbsp;Not allowed
                        </div>
                    </div>
                    <div id="pets">
                        ...
                        <div class="col-sm-3" style="padding-top:6px;">
                            ...
                            <input type="radio" name="pets" id="pet_val" class="required"
                                   value="0" <?php echo($property_details[0]['pets'] == '0' ? 'checked' : ''); ?>>
                            &nbsp;Allowed&nbsp;&nbsp;
                            <input type="radio" name="pets" id="pet_val" class="required"
                                   value="1" <?php echo($property_details[0]['pets'] == '1' ? 'checked' : ''); ?>>
                            &nbsp;Not allowed
                        </div>
                    </div>
                </div>
            ...
            <div class="additional_feature" style="display:none;">
                <div class="form-group">
                    ...
                    <div class="col-sm-10" id="add_feature" style="padding-top:7px;">
                        <input type="checkbox" name="air_conditioning" value="1"
                               id="air_conditioning" <?php echo($property_details[0]['air_conditioning'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;Air Conditioning&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="elevator" value="1"
                               id="elevator" <?php echo($property_details[0]['elevator'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;Elevator&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="balcony" value="1"
                               id="balcony" <?php echo($property_details[0]['balcony'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;Balcony&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="terrace" value="1"
                               id="terrace" <?php echo($property_details[0]['terrace'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;Terrace&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="garden" value="1"
                               id="garden" <?php echo($property_details[0]['garden'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;Garden
                    </div>
                </div>
                <div class="form-group gallery-env" id="row7">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="checkbox" name="add_to_luxury"
                               value="1" <?php echo($property_details[0]['add_to_luxury'] == '1' ? 'checked' : ''); ?>>
                        &nbsp;&nbsp;Add to luxury
                    </div>
                </div>
            </div>
            <div class="form-group gallery-env">
                ...
                <div class="col-sm-8 col-xs-4" data-tag="1d">
                    ...
                    <textarea rows="4" cols="40" id="field" name="description" onKeyUp="countChar(this)"
                              class="form-control required"><?php echo htmlspecialchars($property_details[0]['description']); ?></textarea>

                    <div style="float:left;">(<span
                            id="charNum"><?php echo 500 - strlen($property_details[0]['description']); ?></span>
                        characters left)
                    </div>
                </div>
            </div>
