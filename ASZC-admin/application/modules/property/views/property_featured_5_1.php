        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="featured_start_date" class="form-control datepicker" name="start_date"
                           value="<?php echo $property_feature_details[0]['start_date']; ?>"
                ...
                <select name="number_of_days" class="required">
                    ...
                    for ($i = 1; $i <= 365; $i++) {
                        ...
                        <option value="<?php echo $i;?>"
                                <?php if ($property_feature_details[0]['number_of_days'] == $i){ ?>selected="selected"<?php }?> ><?php echo $i;?></option>
