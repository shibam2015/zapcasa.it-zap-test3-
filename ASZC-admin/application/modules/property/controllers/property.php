...
class Property extends CI_Controller { 
	...
	public function make_prop_feature(){
		...
		redirect('/property/make_featured/' . $property_id . '/' . $type . '/' . $activetype . ($page == '' ? '' : '/' . $page));
	}

	public function make_delete_feature()
	{
		$property_id = $this->uri->segment('3');
		$type = $this->uri->segment('4');
		$activetype = $this->uri->segment('5');
		...
		$rs = $this->property_model->resume_featured_entry_new($property_id);
