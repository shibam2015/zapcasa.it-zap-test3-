...
<div class="main-content">
    ...
    if ($image_path != "") {
        ...
        $propertyImage = frontend_path() . "assets/uploads/thumb_92_82/" . $image_path;
    ...
    $GoogleMapMarkers[0] = array(
        ...
        'proaddress' => $Company_name . '<br>' . $propertyAddress,
        ...
        <div id="add_newproperty_box" class="add_newproperty_box">
            ...
            <div class="add_newproperty_table1" style="width:100%;">
                ...
                <div class="section2" style="border-top:1px solid #cccccc">
                    ...
                    echo form_open_multipart('user/update_location/' . $this->uri->segment('3'), $attributes);
