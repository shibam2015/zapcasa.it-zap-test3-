...
<div class="main-content">
	...
	<span class="filterTbl">
		<a <?php echo($activetype=='all'?'class="selected"':''); ?> href="<?php echo base_url().'user/user_search/'.$type.'/all?search_input='.$search_input; ?>">
			All (<?php echo $allFilterUser; ?>)
		</a>
		-
		<a <?php echo($activetype=='enabled'?'class="selected"':''); ?> href="<?php echo base_url().'user/user_search/'.$type.'/enabled?search_input='.$search_input; ?>">
			Active (<?php echo $enbldFilterUser; ?>)
		</a>
		-
		<a <?php echo($activetype=='disabled'?'class="selected"':''); ?> href="<?php echo base_url().'user/user_search/'.$type.'/disabled?search_input='.$search_input; ?>">
			Inactive (<?php echo $dsbldFilterUser; ?>)
		</a>
		-
		<a <?php echo($activetype=='notverified'?'class="selected"':''); ?> href="<?php echo base_url().'user/user_search/'.$type.'/notverified?search_input='.$search_input; ?>">
