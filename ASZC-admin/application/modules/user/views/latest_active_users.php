...
<span id="search" style="float:right;">

				<form method="post" action="<?php echo base_url();?>user/user_search">

					<input type="text" name="search_input" class="search-input" placeholder="UserName, First Name, Last Name, Email, VAT or Social security" style="width:400px" />
...
<table class="table table-bordered table-striped datatable" id="table-2" width="100%">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="<?php echo base_url();?>"><?php echo $user->user_name?></a></td>				
			...
			<td><?php echo $user->activation_on?></td>				
                       ...
                       echo '<td>
                            ...
                            <a href="'.site_url('/user/edit_profile').'/'.$user->user_id.'/" href="javascript:;" class="btn btn-default btn-sm btn-icon btn-xs" title="Click here to edit">
                            ...
                            <a href="'.site_url('/user/statuschange/').'/'.$user->user_id.'/" class="btn btn-info btn-sm btn-icon btn-xs" title="'.$title.'" Onclick="return confirm(\'Are you sure want change status.\')">

                                <i class="'.$css_class.'"></i>

                                '.$Login_Status.'</a>';?>

                             <a href="<?php echo base_url();?>user/delete_user/<?php echo $user->user_id;?>" class="btn-xs btn-red" onclick="return confirm('Are your sure?')">Delete</a>

                             

                           	<a href="<?php echo base_url();?>user/view_message/<?php echo $user->user_id;?>" class="btn-xs btn-red" >Message</a> 	
