 ...
 */function CheckAuthentication(){
	...
	return true;
}// LicenseKey : Paste your license key here. If left blank, CKFinder will be// fully functional, in demo mode.$config['LicenseName'] = '';$config['LicenseKey'] = '';/*
...
*/$baseUrl = 'http://www.zapcasa.it/zap-test3/assets/cmsfiles/';/*
...
*/$config['RoleSessionVar'] = 'CKFinder_UserRole';//session_start();/*
...
*/$config['AccessControl'][] = Array(
	...
	'folderCreate' => true,
	'folderRename' => true,
	'folderDelete' => true,	'fileView' => true,
	'fileUpload' => true,
	'fileRename' => true,
	'fileDelete' => true);
