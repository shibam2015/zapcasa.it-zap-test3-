 ...
 */ob_start();/** * define required constants
 */require_once dirname(__FILE__) . '/constants.php';// @ob_end_clean();// header("Content-Encoding: none");/**
...
}$utilsSecurity =& CKFinder_Connector_Core_Factory::getInstance("Utils_Security");$utilsSecurity->getRidOfMagicQuotes();/**
 * $config must be initialised
 */$config = array();$config['Hooks'] = array();$config['Plugins'] = array();/**
